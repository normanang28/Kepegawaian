    ...
    <div class="card">
        <div class="card-body">
            <div class="basic-form">
                <form class="form-horizontal form-label-left" novalidate action="<?= base_url('home/aksi_edit_gaji')?>" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="id_pegawai" class="form-control text-capitalize" id="id_pegawai" required>
                             <option class="text-capitalize" value="<?= $jofinson->id_pegawai?>"><?= $jofinson->nama_pegawai?></option>
                        ...
                        <label class="form-label">Nominal <span style="color: red;">*</span></label>
                            <div class="input-group">
                                ...
                                <input type="text" id="harga_gaji" name="harga_gaji" class="form-control text-capitalize" placeholder="Nominal" value="<?= $jofinson->harga_gaji?>">
                            </div>
                        </div>
                        <div class="input input-group">
                            <label class="form-label">Tanggal Gajian <span style="color: red;">*</span></label>
                            <div class="col-12">
                            <input type="date" id="tanggal_gaji" name="tanggal_gaji" class="form-control text-capitalize" placeholder="Tanggal Gajian" value="<?= $jofinson->tanggal_gaji?>">
                            </div>
                        </div>
                    </div>
                    <div class="mt-3">
